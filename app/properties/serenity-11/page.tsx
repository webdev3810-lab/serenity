...
export const metadata = pageMetadata("Serenity 11 - Whole", "View Serenity 11, a four-bedroom furnished house in Pakenham, Victoria, Australia.");
export const dynamic = "force-dynamic";

export default async function Page() {
  const [property, relatedProperties] = await Promise.all([getPublicPropertyBySlug("serenity-11"), getPublicProperties()]);
